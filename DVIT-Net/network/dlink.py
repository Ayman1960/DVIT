...
if __name__ == "__main__":
    ...
    # Example usage:
    # net_pretrained = DinkNet34(pretrained=True)  # With pretrained weights
    # net_random_init = DinkNet34(pretrained=False)  # Without pretrained weights
    # net_pretrained.to(device)
    # net_random_init.to(device)
    # segout_pretrained = net_pretrained(input)
    # segout_random = net_random_init(input)
    # print(segout_pretrained.size())
    # print(segout_random.size())